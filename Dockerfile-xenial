...
# Basic Requirements
RUN apt-get -y install mysql-client pwgen nginx php-fpm php-mysql php-apcu python-setuptools curl unzip php-curl php-gd php-intl php-pear php-imagick php-imap php-mcrypt php-memcache php-pspell php-recode php-sqlite3 php-tidy php-xmlrpc php-xml bzip2 xz-utils zip
